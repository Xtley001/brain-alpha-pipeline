# Multi-Category Alpha Knowledge Base — Master (Analyst Estimates, Short Lending, Supply Chain & Hybrids)

**Status:** Extracted and formulated from 15 foundational peer-reviewed academic papers and institutional quantitative textbooks in `docs/research/`, including Givoly & Lakonishok (1979), Diether-Malloy-Scherbina (2002), Bernard & Thomas (1989, 1990), Cohen-Diether-Malloy (2007), Engelberg-Reed-Ringgenberg (2012), Rapach-Ringgenberg-Zhou (2016), Asquith-Pathak-Ritter (2005), Barrot & Sauvagnat (2016), Fabozzi et al. (2010), and Kathryn Staley (*The Art of Short Selling*).

**Literature Base:**
1. **Givoly & Lakonishok (1979)** — *The Information Content of Financial Analysts' Forecasts of Earnings* (Journal of Accounting and Economics)
2. **Diether, Malloy, & Scherbina (2002)** — *Differences of Opinion and the Cross-Section of Stock Returns* (Journal of Finance)
3. **Bernard & Thomas (1989, 1990)** — *Post-Earnings-Announcement Drift: Delayed Price Response or Risk Premium?* (Journal of Accounting Research)
4. **Martineau (2021)** — *Rest in Peace Post-Earnings Announcement Drift* (Modern Information Diffusion & Event Windows)
5. **Fabozzi, Focardi, & Kolm (2010)** — *Quantitative Equity Investing: Techniques and Strategies* (Wiley Finance)
6. **Cohen, Diether, & Malloy (2007)** — *Supply and Demand Shifts in the Shorting Market* (Journal of Finance)
7. **Engelberg, Reed, & Ringgenberg (2012)** — *How are Shorts Informed? Short Sellers, News, and Information Processing* (Journal of Finance)
8. **Asquith, Pathak, & Ritter (2005)** — *Short Interest, Institutional Ownership, and Stock Returns* (Journal of Financial Economics)
9. **Rapach, Ringgenberg, & Zhou (2016)** — *Short Interest and Aggregate Stock Returns* (Journal of Financial Economics)
10. **Kathryn F. Staley (1997)** — *The Art of Short Selling* (Wiley)
11. **Barrot & Sauvagnat (2016)** — *Input Specificity and the Propagation of Idiosyncratic Shocks in Production Networks* (Quarterly Journal of Economics)
12. **Cohen & Frazzini (2008)** — *Economic Links and Predictable Returns* (Journal of Finance)
13. **Lead-Lag Detection and Network Clustering (2022)** — *Multivariate Time Series with an Application to US Equities*
14. **Option Volume Imbalance as a Predictor for Equity Market Returns (2022)** — *Information Asymmetry in Derivative Flow*
15. **The Dynamic Relation Between Short Sellers, Option Traders, and Stock Returns (2012)** — *Cross-Market Information Transmission*

---

## 1. ANALYST ESTIMATES & EARNINGS REVISIONS
